    ...
    <div id="container">
        <div>
            ...
            <div class="post-container">
                <TodoItem v-for="(info, index) in data"
                        :key="index"
                        :id="info.userId"
                        :title="info.title"
        ...
        <div class="message-container">
            <div>
                ...
                <input v-model="body" type="text" name="bodyInput" id="bodyInput" placeholder="true/false"/>
            </div>
...
export default {
    ...
    methods: {
       ...
       putReq() {
           ...
           fetch("https://jsonplaceholder.typicode.com/todos/"+this.id, options)
           .then(res=>res.json())
           .then(data=>(this.data = data));
       },
       patchReq() {
