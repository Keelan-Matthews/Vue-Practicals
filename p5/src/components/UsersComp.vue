    ...
    <div id="container">
        <div>
            ...
            <div class="post-container">
                <UserItem v-for="(info, index) in data"
                        :key="index"
                        :id="info.id"
                        :name="info.name"
                        :email="info.email" />
        ...
        <div class="message-container">
            <div>
                <div class="d-flex">
                    ...
                    <input v-model="title" type="text" name="titleInput" id="titleInput" placeholder="Name"/>
                </div>
                <input v-model="body" type="text" name="bodyInput" id="bodyInput" placeholder="Email"/>
            </div>
...
export default {
    ...
    methods: {
       getReq() {
           fetch("https://jsonplaceholder.typicode.com/users?id="+this.id)
           .then(res=>res.json())
       ...
       putReq() {
           ...
           fetch("https://jsonplaceholder.typicode.com/users/"+this.id, options)
           .then(res=>res.json())
           .then(data=>(this.data = data));
       },
       patchReq() {
